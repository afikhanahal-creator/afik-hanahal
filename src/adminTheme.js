...
export const ADMIN_DARK_C  = { bg: '#09090F', purple: '#8490D8', green: '#82F67F', cream: '#E8E4D8', card: '#0E0E1C' }
export const ADMIN_LIGHT_C = { bg: '#F4F5F9', purple: '#4452C4', green: '#15803D', cream: '#171A2C', card: '#FFFFFF' }
...
:root, html[data-admin-theme="dark"] {
  color-scheme: dark;
  --ink: 232,228,216; --ov: 255,255,255; --shade: 0,0,0;
  ...
  --au-s1: rgba(255,255,255,.03); --au-s1-line: rgba(132,144,216,.14);
  --au-s2: #10121E; --au-s2-line: rgba(132,144,216,.25);
  --au-s3: rgba(255,255,255,.04); --au-s3-line: rgba(132,144,216,.22);
  --au-line: rgba(132,144,216,.14); --au-line2: rgba(132,144,216,.25); --au-divider: rgba(132,144,216,.08);
  --au-text: #E8E4D8; --au-text2: rgba(232,228,216,.72); --au-text3: rgba(232,228,216,.6); --au-text-dis: rgba(232,228,216,.35);
  --au-brand-soft: rgba(132,144,216,.14); --au-brand-text: #A3ADEB; --au-amber-text: #F5C26B; --au-red-text: #F08A8A; --au-green-text: #4ADE80;
  ...
  --au-seg-active: rgba(132,144,216,.22);
...
html[data-admin-theme="light"] {
  color-scheme: light;
  --ink: 23,26,44; --ov: 28,36,90; --shade: 20,24,60;
  ...
  --au-brand-soft: rgba(68,82,196,.09); --au-brand-text: #3F4EB0; --au-amber-text: #9A5B00; --au-red-text: #C0392B; --au-green-text: #15803D;
...
.admin-cmdk-btn:hover { border-color: rgba(132,144,216,.45) !important; color: var(--au-text2) !important; }
