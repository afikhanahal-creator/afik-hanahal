...
export function propertyToWizardData(prop) {
  ...
  return {
    ...
    amenities: {
      ...
      parking:     !!(prop.parking || prop.parkingCount > 0),
      storage:     !!prop.storage,
      shelter:     !!prop.safeRoom,
      balcony:     !!(prop.balcony || prop.balconies > 0),
      pool:        !!prop.pool,
      kosher:      !!prop.kosher,
      ...
      doorman:     !!prop.doorman,
      tornado_ac:  !!prop.tornadoAC,
      boiler:      !!prop.boiler,
      // Commercial amenities
      kitchenette: !!prop.kitchenette,
      alarm:       !!prop.alarm,
      cameras:     !!prop.cameras,
      conf_room:   !!prop.conferenceRoom,
      comm_room:   !!prop.commRoom,
      mamak:       !!prop.mamak,
    },
...
export function wizardToProperty(d, isDraft) {
  ...
  return {
    ...
    balcony: d.balconies > 0 || !!d.amenities?.balcony,
  ...
  return (
    <div>
      ...
      <p style={{ color: MUTED, fontSize: 14, marginBottom: 24, lineHeight: 1.7, fontFamily: FONT }}>
        עד 20 תמונות + עד 3 סרטונים. תמונות איכותיות מגדילות משמעותית את הסיכוי למכירה מהירה.
      </p>
