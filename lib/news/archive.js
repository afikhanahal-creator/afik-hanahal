// News archive (served by api/news.js at /api/news/archive — Vercel Hobby allows 12 functions, so this is not its own function).
// The archive modal: every stored real-estate article from the last 30 days.
...
import { titleKey } from './sources.js'
