// Vercel serverless — proxies AI messages POST to Render backend
...
export default async function handler(req, res) {
  ...
  try {
    const r = await fetch(`${RENDER}/api/ai/messages`, {
      method:  'POST',
      headers: {
    ...
    console.error('[ai/messages vercel] error:', e.message)
